...
console.log('task 1b', createMenuItem('burger', 7, 'Breakfast'));
console.log('task 1b', createMenuItem('Cake', 9, 'Dessert'));
...
function getLastReview(array) {
  ...
  const {name, rating, feedback} = LastReview
